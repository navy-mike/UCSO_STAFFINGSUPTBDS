...
type st_3 from statictext within w_judicial
end type
type st_2 from statictext within w_judicial
end type
type cbx_show_birthdays from checkbox within w_judicial
end type
type dw_jud_group6 from datawindow within w_judicial
end type
type dw_jud_group5 from datawindow within w_judicial
end type
type dw_jud_group4 from datawindow within w_judicial
end type
...
type dw_jud_group2 from datawindow within w_judicial
end type
type dw_jud_group1 from datawindow within w_judicial
end type
type dw_jud_supr2 from datawindow within w_judicial
end type
type dw_jud_supr1 from datawindow within w_judicial
end type
type dw_jud_chief from datawindow within w_judicial
end type
...
type ln_3 from line within w_judicial
end type
type ln_4 from line within w_judicial
end type
type ln_5 from line within w_judicial
end type
type r_1 from rectangle within w_judicial
end type
type r_2 from rectangle within w_judicial
end type
end forward
...
dw_clicked_object = f_getDwDispJudObjectByGrpid_mod(ll_clicked_grpid, ls_subgrpid, dw_jud_chief, dw_jud_supr1, dw_jud_supr2, dw_jud_group1, dw_jud_group2, dw_jud_group3, dw_jud_group4, dw_jud_group5, dw_jud_group6, dw_jud_admin, ref li_valid_object)
