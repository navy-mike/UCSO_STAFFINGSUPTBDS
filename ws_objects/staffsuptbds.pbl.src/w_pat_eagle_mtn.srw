$PBExportHeader$w_pat_eagle_mtn.srw
forward
global type w_pat_eagle_mtn from window
end type
type dw_lt1 from datawindow within w_pat_eagle_mtn
end type
type dw_disp_em101 from datawindow within w_pat_eagle_mtn
end type
type dw_disp_em102 from datawindow within w_pat_eagle_mtn
end type
type dw_disp_emsro from datawindow within w_pat_eagle_mtn
end type
type dw_disp_em201 from datawindow within w_pat_eagle_mtn
end type
type dw_disp_em202 from datawindow within w_pat_eagle_mtn
end type
type pb_14 from picturebutton within w_pat_eagle_mtn
end type
type st_1 from statictext within w_pat_eagle_mtn
end type
end forward
...
boolean center = true
dw_lt1 dw_lt1
dw_disp_em101 dw_disp_em101
dw_disp_em102 dw_disp_em102
dw_disp_emsro dw_disp_emsro
dw_disp_em201 dw_disp_em201
dw_disp_em202 dw_disp_em202
pb_14 pb_14
st_1 st_1
end type
global w_pat_eagle_mtn w_pat_eagle_mtn

on w_pat_eagle_mtn.create
this.dw_lt1=create dw_lt1
this.dw_disp_em101=create dw_disp_em101
this.dw_disp_em102=create dw_disp_em102
this.dw_disp_emsro=create dw_disp_emsro
this.dw_disp_em201=create dw_disp_em201
this.dw_disp_em202=create dw_disp_em202
this.pb_14=create pb_14
this.st_1=create st_1
this.Control[]={this.dw_lt1,&
this.dw_disp_em101,&
this.dw_disp_em102,&
this.dw_disp_emsro,&
this.dw_disp_em201,&
...
on w_pat_eagle_mtn.destroy
destroy(this.dw_lt1)
destroy(this.dw_disp_em101)
destroy(this.dw_disp_em102)
destroy(this.dw_disp_emsro)
destroy(this.dw_disp_em201)
destroy(this.dw_disp_em202)
destroy(this.pb_14)
destroy(this.st_1)
end on
...
ll_num_retrieved = dw_lt1.Retrieve(8)

//dw_disp_em1
dw_disp_em101.settransobject(sqlca)
ll_num_retrieved = dw_disp_em101.Retrieve(8)

//dw_disp_em2
dw_disp_em102.settransobject(sqlca)
ll_num_retrieved = dw_disp_em102.Retrieve(8)

dw_disp_em201.settransobject(sqlca)
ll_num_retrieved = dw_disp_em201.Retrieve(9)

dw_disp_em202.settransobject(sqlca)
ll_num_retrieved = dw_disp_em202.Retrieve(9)

//dw_disp_emsro
dw_disp_emsro.settransobject(sqlca)
ll_num_retrieved = dw_disp_emsro.Retrieve(10)
end event
...
string title = "none"
string dataobject = "dw_disp_teams_em12_01"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
string dragicon = "\\ucfs1\apps\pix\ucso_staffing\UCSOSTAFFGRN.ICO"
string title = "none"
string dataobject = "dw_disp_teams_em12_02"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
event clicked;close(w_pat_eagle_mtn)
end event
...
long backcolor = 67108864
string text = "Eagle Mountain Assignments"
