$PBExportHeader$w_pat_chief_deputy.srw
forward
global type w_pat_chief_deputy from window
end type
type cbx_show_birthdays from checkbox within w_pat_chief_deputy
end type
type st_2 from statictext within w_pat_chief_deputy
end type
type st_3 from statictext within w_pat_chief_deputy
end type
type st_4 from statictext within w_pat_chief_deputy
end type
...
dw_disp_vine1 dw_disp_vine1
dw_disp_rec2 dw_disp_rec2
dw_disp_rec1 dw_disp_rec1
dw_disp_d dw_disp_d
dw_disp_c dw_disp_c
dw_disp_b dw_disp_b
dw_lt3 dw_lt3
...
this.dw_disp_vine1=create dw_disp_vine1
this.dw_disp_rec2=create dw_disp_rec2
this.dw_disp_rec1=create dw_disp_rec1
this.dw_disp_d=create dw_disp_d
this.dw_disp_c=create dw_disp_c
this.dw_disp_b=create dw_disp_b
this.dw_lt3=create dw_lt3
this.dw_lt2=create dw_lt2
this.dw_lt1=create dw_lt1
this.dw_lt4=create dw_lt4
this.dw_disp_a=create dw_disp_a
this.st_1=create st_1
this.pb_14=create pb_14
this.Control[]={this.cbx_show_birthdays,&
this.st_2,&
this.st_3,&
this.st_4,&
this.lb_1,&
...
destroy(this.dw_disp_vine1)
destroy(this.dw_disp_rec2)
destroy(this.dw_disp_rec1)
destroy(this.dw_disp_d)
destroy(this.dw_disp_c)
destroy(this.dw_disp_b)
destroy(this.dw_lt3)
destroy(this.dw_lt2)
destroy(this.dw_lt1)
destroy(this.dw_lt4)
destroy(this.dw_disp_a)
destroy(this.st_1)
destroy(this.pb_14)
end on
...
dw_disp_rec2.settransobject(sqlca)
ll_num_retrieved = dw_disp_rec2.Retrieve(6)

//dw_disp_vine1
dw_disp_vine1.settransobject(sqlca)
ll_num_retrieved = dw_disp_vine1.Retrieve(11)

//dw_disp_vine2
dw_disp_vine2.settransobject(sqlca)
ll_num_retrieved = dw_disp_vine2.Retrieve(11)

//dw_disp_smcont
dw_disp_smcont.settransobject(sqlca)
ll_num_retrieved = dw_disp_smcont.Retrieve(12)
...
string dragicon = "\\ucfs1\apps\pix\ucso_staffing\UCSOSTAFFGRN.ICO"
string title = "none"
string dataobject = "dw_disp_teams_vine1"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
string ls_dispbd_object_name
string ls_empno_object_name
string ls_row
string ls_grpname
string ls_picobj
string ls_empname
...
for ll_row = 1 to li_max_disp_objects
	...
	ls_dispbd_object_name = "dispbd_" + ls_row
	ls_empno_object_name = "empno_" + ls_row
	if(ll_row <= ll_rowcount) then
		li_dispbd = dw_object.getitemnumber(row, ls_dispbd_object_name)
		if(li_dispbd > 0) then
			integer li_stop
			li_stop = 0
		end if
		...
		ll_empno = dw_object.getitemnumber(row, ls_empno_object_name)
		if(gb_show_all_birthdays = true) then
			if(li_dispbd = 0) then
				integer li_oktoshowbd
				li_oktoshowbd = 0
				//
				select oktoshowbd into :li_oktoshowbd from sns_employees where empno = :ll_empno using sqlca;
				//
				if(li_oktoshowbd = 1) then
					dw_object.setitem(row, ls_dispbd_object_name, 4)
				end if			
			end if
		else
			dw_object.setitem(row, ls_dispbd_object_name, li_dispbd)
		end if
	else
